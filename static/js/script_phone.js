...
// Précharger les sons
const buzzSound = new Audio(window.mediaPaths.enter);
buzzSound.volume = 0.5;

// Jouer le son de buzz local
const playBuzzSound = () => {
  buzzSound.currentTime = 0;
  buzzSound.play().catch(e => console.log('Son bloqué:', e));
};
...
function setupTeam(color) {
  ...
  // Activer les sons avec une première interaction
